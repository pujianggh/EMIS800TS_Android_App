...
public class FeedbackActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        setTitleBarLayout(R.drawable.icon_back_white_bar, getResources().getString(R.string.text_feed_back_title), null,  getResources().getString(R.string.text_button_tj), true);
