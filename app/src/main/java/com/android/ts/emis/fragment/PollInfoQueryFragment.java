...
public class PollInfoQueryFragment extends BaseFragment {
    ...
    protected void initView(Bundle savedInstanceState) {
        setContentView(R.layout.fragment_pollinfo_query);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_confirm:
                //((WorkOrderQueryListActivity) getActivity()).setQueryInfo();
                break;
