...
public abstract class AbstractDownloadMgr {
    ...
    private HashMap<String, com.fengniao.okhttputils.action.download_mgr.DownloadTask> mDownloadTaskPool;    //下载池

    private com.fengniao.okhttputils.action.download_mgr.DownloadTaskListener mDownloadTaskListener;     //任务监听
    private LinkedList<com.fengniao.okhttputils.action.download_mgr.DownloadTaskListener> mDownloadTaskListenerList;    //task监听事件List
    ...
    public AbstractDownloadMgr(Builder builder) {
        ...
        mDownloadTaskListener = new com.fengniao.okhttputils.action.download_mgr.DownloadTaskListener() {
            @Override
            public void onStart(String taskId, long completeBytes, long totalBytes) {
                ...
                for(com.fengniao.okhttputils.action.download_mgr.DownloadTaskListener downloadTaskListener : mDownloadTaskListenerList) {
            ...
            public void onFinish(String taskId, File file) {
                ...
                //清理任务 移除队列和下载池
                com.fengniao.okhttputils.action.download_mgr.DownloadTask downloadTask = mDownloadTaskPool.get(taskId);
     ...
     * @param task Task
     */
    public com.fengniao.okhttputils.action.download_mgr.DownloadTask addTask(Task task) {
        if(DEBUG) {
        ...
        com.fengniao.okhttputils.action.download_mgr.DownloadTask downloadTask = new com.fengniao.okhttputils.action.download_mgr.DownloadTask();
    ...
    public void startTask(String taskId) {
        ...
        if(mCurDownloadIngNum < mMaxDownloadIngNum) {
            ...
            downloadTask.setStatus(com.fengniao.okhttputils.action.download_mgr.DownloadStatus.STATUS_WAIT);   //超过总下载数量则设置为等待
        }
    }
    ...
    private void startNextTask() {
        ...
        for(int i = 0; i < mDownloadTaskQuene.size(); i ++) {
            com.fengniao.okhttputils.action.download_mgr.DownloadTask downloadTask = mDownloadTaskPool.get(mDownloadTaskQuene.get(i));
            if(downloadTask.getStatus() == com.fengniao.okhttputils.action.download_mgr.DownloadStatus.STATUS_WAIT) {
                if(DEBUG) {
     ...
     */
    public void addListener(com.fengniao.okhttputils.action.download_mgr.DownloadTaskListener downloadTaskListener) {
     ...
     * @param downloadTaskListener
     */
    public void removeListener(com.fengniao.okhttputils.action.download_mgr.DownloadTaskListener downloadTaskListener) {
     ...
     * @return
     */
    public com.fengniao.okhttputils.action.download_mgr.DownloadTask getDownloadTask(String taskId) {
    ...
    public static abstract class Builder {
        ...
        public Builder() {
            mOkHttpCall = new com.fengniao.okhttputils.action.OkHttpCall();
            mMaxDownloadIngNum = DEFAULT_MAX_DOWNLOADING_NUM;
            mSaveProgressBytes = DEFAULT_SAVE_PROGRESS_BYTES;
        }

        public Builder myOkHttp(@NonNull com.fengniao.okhttputils.action.OkHttpCall myOkHttp) {
