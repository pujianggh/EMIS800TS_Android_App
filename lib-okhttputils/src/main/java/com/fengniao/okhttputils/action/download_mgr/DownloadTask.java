...
public class DownloadTask {
    ...
    private com.fengniao.okhttputils.action.download_mgr.DownloadTaskListener mDownloadTaskListener;    //task监听事件
    ...
    public com.fengniao.okhttputils.action.OkHttpCall getMyOkHttp() {
        return mOkHttpCall;
    }

    public void setMyOkHttp(com.fengniao.okhttputils.action.OkHttpCall okHttpCall) {
    ...
    public void setDownloadTaskListener(com.fengniao.okhttputils.action.download_mgr.DownloadTaskListener downloadTaskListener) {
