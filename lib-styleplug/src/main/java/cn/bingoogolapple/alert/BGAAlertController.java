...
package cn.bingoogolapple.alert;
...
import cn.bingoogolapple.titlebar.R;
...
public class BGAAlertController extends Dialog implements View.OnClickListener, DialogInterface.OnShowListener {
    ...
    public BGAAlertController(Activity activity, CharSequence title, CharSequence message, AlertControllerStyle preferredStyle) {
        ...
        setContentView(R.layout.bga_sheetview_alert_controller);
    ...
    private void initAnim() {
        mAlertEnterAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.bga_ac_alert_enter);
        mAlertExitAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.bga_ac_alert_exit);
        ...
        mActionSheetEnterAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.bga_ac_action_sheet_enter);
        mActionSheetExitAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.bga_ac_action_sheet_exit);
        ...
        mAlphaEnterAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.bga_ac_alpha_enter);
        mAlphaExitAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.bga_ac_alpha_exit);
