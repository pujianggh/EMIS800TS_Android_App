    ...
    public static void handleBackground(ViewGroup container) {
        if (container.getChildAt(0).getVisibility() == View.VISIBLE) {
                ...
                for (int i = 2; i < container.getChildCount(); i++) {
                    ...
                    if (child instanceof BGAActionItemView) {
                        if (i == container.getChildCount() - 1) {
                            child.setBackgroundResource(R.drawable.bga_ac_selector_bottom);
                        } else {
                            child.setBackgroundResource(R.drawable.bga_ac_selector_center);
                        }
                    }
                }
            }
            ...
            if (container.getChildCount() == 3) {
                ...
                container.getChildAt(1).setBackgroundResource(R.drawable.bga_ac_selector_cancel);
                ...
                for (int i = 1; i < container.getChildCount(); i++) {
                    ...
                    if (child instanceof BGAActionItemView) {
                        if (i == 1) {
                            child.setBackgroundResource(R.drawable.bga_ac_selector_top);
