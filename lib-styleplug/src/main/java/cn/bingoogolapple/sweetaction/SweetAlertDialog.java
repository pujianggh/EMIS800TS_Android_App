package cn.bingoogolapple.sweetaction;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sweetalert_dialog_view);
    ...
    private void restore () {
        ...
        mConfirmButton.setBackgroundResource(R.drawable.sweetalert_button_blue_bg);
        ...
        if (mDialogView != null) {
            ...
            switch (mAlertType) {
                ...
                case SUCCESS_TYPE:
                    ...
                    break;
                case WARNING_TYPE:
                    mConfirmButton.setBackgroundResource(R.drawable.sweetalert_button_red_bg);
